...
export const it = {
  ...
  'models.sonnet5': 'Claude Sonnet 5 — equilibrato, consigliato ($2/$10 per milione di token)',
  ...
  'models.grok46': 'Grok 4.6 — l’ultimo di xAI, il più capace',
  'models.grok45': 'Grok 4.5 — generazione precedente',
  'models.grok43': 'Grok 4.3 — più economico, testi molto lunghi',
  ...
  'models.deepseekFlash': 'DeepSeek Flash — molto economico, il più usato',
  'models.deepseekPro': 'DeepSeek V4 Pro — più accurato, costa di più',
  ...
  'tmodels.largeV3Turbo': 'Whisper large v3 turbo — velocissimo, quasi preciso uguale',
